 ...
 * OBSERVAÇÕES:
 * 
 * NÃO é permitido o uso de nenhuma estrutura de repetição (for, while,
 * do-while).
 * 
...
//feito  
		...
		List<Account> jointAccounts = getContasConjuntas(service.listClients());

		jointAccounts.forEach(account -> System.out.println("Número da conta conjunta: " + account.getNumber()));
...
// Feito  
		...
		service
				...
				.filter(cliente -> cliente.getAccounts().stream()
...
//feito  
		...
		System.out.println("Números das contas no Brasil: " + IntStream.of(countryNumbers)
